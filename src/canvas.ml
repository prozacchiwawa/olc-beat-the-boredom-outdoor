...
external createImageData : context2d -> int -> int -> imageData = "createImageData" [@@bs.send]
external putImageData : context2d -> imageData -> int -> int -> unit = "putImageData" [@@bs.send]
...
external toDataURL : canvas -> string = "toDataURL" [@@bs.send]

external fillRect : context2d -> int -> int -> int -> int -> unit = "fillRect" [@@bs.send]
...
external fillText : context2d -> string -> int -> int -> unit = "fillText" [@@bs.send]
external measureText : context2d -> string -> textMetrics = "measureText" [@@bs.send]
