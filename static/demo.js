...
},{"./canvas.bs.js":33,"./color.bs.js":36,"./constants.bs.js":37,"./contypes.bs.js":38,"./gamepalette.bs.js":41,"./math.bs.js":46,"./menu.bs.js":47,"./sprite.bs.js":52,"./spriteDefs.bs.js":53,"./weather.bs.js":55,"./worldmap.bs.js":58,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/caml_obj.js":15,"bs-platform/lib/js/caml_primitive.js":17,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25,"bs-platform/lib/js/printf.js":28}],41:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function oneFrame(game, ts) {
  ...
  var game$2 = newWeatherBlock && Weather.weatherChangePct < Math.random() ? runWeather(game$1) : game$1;
  var game$3 = newWeek ? Plants.runPlants(game$2) : game$2;
  var playerRes = PlayerMethods.moveCloserToTarget(game$3, timeInc, game$3.player);
  var game_startTime$1 = game$3.startTime;
  var game_worldTime = game$3.worldTime;
  var game_realTime = game$3.realTime;
  var game_lastTs$1 = game$3.lastTs;
  var game_timeOfDay = game$3.timeOfDay;
  var game_gameSpeed$1 = game$3.gameSpeed;
  var game_mode$1 = game$3.mode;
  var game_weather$1 = game$3.weather;
  var game_world$1 = game$3.world;
  var game_keys$1 = game$3.keys;
  var game_cities$1 = game$3.cities;
  var game_workers$1 = game$3.workers;
  var game_plants$1 = game$3.plants;
  var game$4 = {
  ...
  var workerRes = List.map((function (param) {
          return WorkerMethods.runWorker(game$4, timeInc, param);
        }), List.map((function (param) {
              return param[1];
            }), Curry._1(Contypes.StringMap.bindings, game_workers$1)));
  var game$5 = List.fold_left(takeWorkerResults, game$4, workerRes);
  var cityRes = List.map((function (param) {
          return CityMethods.runCity(game$5, timeInc, param);
        }), List.map((function (param) {
              return param[1];
            }), Curry._1(Contypes.StringMap.bindings, game$5.cities)));
  var game$6 = List.fold_left(takeCityUpdate, game$5, cityRes);
  if (Curry._1(Contypes.StringMap.cardinal, game$6.cities) === 0) {
    return {
            startTime: game$6.startTime,
            worldTime: game$6.worldTime,
            realTime: game$6.realTime,
            lastTs: game$6.lastTs,
            timeOfDay: game$6.timeOfDay,
            gameSpeed: game$6.gameSpeed,
            player: game$6.player,
            mode: /* GameOverScreen */Block.__(0, [game$6.realTime + 5000.0]),
            weather: game$6.weather,
            world: game$6.world,
            keys: game$6.keys,
            cities: game$6.cities,
            workers: game$6.workers,
            plants: game$6.plants
          };
  } else {
    return game$6;
  }
...
},{"./cityMethods.bs.js":35,"./constants.bs.js":37,"./contypes.bs.js":38,"./gamestate.bs.js":42,"./life.bs.js":44,"./math.bs.js":46,"./plants.bs.js":50,"./playerMethods.bs.js":51,"./tod.bs.js":54,"./weather.bs.js":55,"./workerMethods.bs.js":57,"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/caml_primitive.js":17,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25}],44:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./math.bs.js":46}],56:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
