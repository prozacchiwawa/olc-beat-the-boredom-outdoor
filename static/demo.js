...
function whatWeKnowToTarget(v) {
  if (v.tag) {
    ...
    return /* tuple */[
            (function (param) {
                return WorkerMethods.addWorkerFood(15.0, param);
              }),
    ...
    return /* tuple */[
            (function (param) {
                return WorkerMethods.addWorkerFood(5.0, param);
              }),
            /* TargetCoords */Block.__(1, [/* tuple */[
                  match$1[0],
                  match$1[1]
...
function getAdvantageousOutings(gamestate, city) {
  ...
  var knowAbout = Curry._1(Contypes.IPointMap.bindings, gamestate.known);
...
function spawnWorker(gamestate, city) {
  ...
  if (match !== undefined) {
    ...
    var updated_population = city.population - 10.0;
    var updated_minerals = city.minerals;
...
function runCity(gamestate, incT, city) {
  if (city.ruin > 0.0) {
    ...
    var cityWithFood_population = city.population;
    var cityWithFood_minerals = city.minerals;
    var cityWithFood = {
      x: cityWithFood_x,
      y: cityWithFood_y,
      ruin: cityWithFood_ruin,
      name: cityWithFood_name,
      population: cityWithFood_population,
...
},{"./contypes.bs.js":37,"./math.bs.js":44,"./workerMethods.bs.js":54,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_primitive.js":17,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25,"bs-platform/lib/js/printf.js":28}],35:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_primitive.js":17,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/printf.js":28}],36:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/caml_obj.js":15,"bs-platform/lib/js/caml_option.js":16,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/map.js":26,"bs-platform/lib/js/set.js":29}],38:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./animate.bs.js":32,"./canvas.bs.js":33,"./constants.bs.js":36,"./contypes.bs.js":37,"./gamedisplay.bs.js":39,"./gamestateMethods.bs.js":42,"./perlin.bs.js":47,"./window.bs.js":53,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/string.js":30}],39:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function worldPositionToScreen(state, x, y) {
  var xx = Caml_int32.div(Caml_int32.imul(x | 0, state.spec.width), state.game.world.groundX);
  var yy = Caml_int32.div(Caml_int32.imul(y | 0, state.spec.height), state.game.world.groundY);
  return /* tuple */[
          xx,
          yy
        ];
...
function drawHud(state) {
  var str = state.game.paused ? Curry._1(Printf.sprintf(/* Format */[
              /* String_literal */Block.__(11, [
                  "[PAUSE] TOD ",
                  /* Float */Block.__(8, [
                      /* Float_f */0,
              ...
              "[PAUSE] TOD %f"
            ]), state.game.timeOfDay) : Curry._1(Printf.sprintf(/* Format */[
              /* String_literal */Block.__(11, [
                  "[~RUN~] TOD ",
                  /* Float */Block.__(8, [
                      /* Float_f */0,
  ...
  if (typeof match === "number") {
    switch (match) {
      case /* HomeScreen */0 :
          ...
          var sunnyGame_known = theGame.known;
...
},{"./canvas.bs.js":33,"./color.bs.js":35,"./contypes.bs.js":37,"./gamepalette.bs.js":40,"./menu.bs.js":45,"./sprite.bs.js":49,"./spriteDefs.bs.js":50,"./worldmap.bs.js":55,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25,"bs-platform/lib/js/printf.js":28}],40:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/caml_array.js":5}],41:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./contypes.bs.js":37,"bs-platform/lib/js/curry.js":24}],42:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function newGame(world) {
  ...
  return {
          ...
          known: Contypes.IPointMap.empty,
          plants: Contypes.IPointSet.empty
        };
}

function generateStartCities(game) {
  var cities = $$Array.init(4, (function (param) {
          var cx = Math.random() * Constants.worldSide;
          var cy = Math.random() * Constants.worldSide;
          return {
                  x: cx | 0,
                  y: cy | 0,
                  ruin: 0.0,
  ...
  return {
          ...
          paused: game.paused,
          keys: game.keys,
          cities: $$Array.fold_left((function (m, c) {
                  return Curry._3(Contypes.StringMap.add, c.name, c, m);
                }), Contypes.StringMap.empty, cities),
...
function oneFrame(game, ts) {
  ...
  var workerRes = List.map((function (param) {
          return WorkerMethods.runWorker(game$1, timeInc, param);
        }), List.map((function (param) {
              return param[1];
            }), Curry._1(Contypes.StringMap.bindings, game_workers)));
  var game$2 = List.fold_left(takeWorkerResults, game$1, workerRes);
  var cityRes = List.map((function (param) {
          return CityMethods.runCity(game$2, timeInc, param);
        }), List.map((function (param) {
              return param[1];
            }), Curry._1(Contypes.StringMap.bindings, game$2.cities)));
  var game$3 = List.fold_left(takeCityUpdate, game$2, cityRes);
  if (Curry._1(Contypes.StringMap.cardinal, game$3.cities) === 0) {
    return {
            startTime: game$3.startTime,
            worldTime: game$3.worldTime,
            realTime: game$3.realTime,
            timeOfDay: game$3.timeOfDay,
            gameSpeed: game$3.gameSpeed,
            player: game$3.player,
            mode: /* GameOverScreen */[game$3.realTime + 5000.0],
            weather: game$3.weather,
            world: game$3.world,
            paused: game$3.paused,
            keys: game$3.keys,
            cities: game$3.cities,
            workers: game$3.workers,
            known: game$3.known,
            plants: game$3.plants
          };
  } else {
    return game$3;
  }
...
function runGame(game$prime, keys, ts) {
  ...
  var game$prime$prime_startTime = game$prime.startTime;
  var game$prime$prime_worldTime = game$prime.worldTime;
  var game$prime$prime_realTime = game$prime.realTime;
  var game$prime$prime_timeOfDay = game$prime.timeOfDay;
  var game$prime$prime_gameSpeed = game$prime.gameSpeed;
  var game$prime$prime_player = game$prime.player;
  var game$prime$prime_mode = game$prime.mode;
  ...
  var game$prime$prime_known = game$prime.known;
  var game$prime$prime_plants = game$prime.plants;
  var game$prime$prime = {
    ...
    known: game$prime$prime_known,
    plants: game$prime$prime_plants
  };
  var match = game$prime$prime_mode;
  if (typeof match === "number") {
    if (match !== 0) {
      var paused = spacePressed ? !game$prime$prime_paused : game$prime$prime_paused;
      var gameWithPause_startTime = game$prime$prime_startTime;
      var gameWithPause_worldTime = game$prime$prime_worldTime;
      var gameWithPause_realTime = game$prime$prime_realTime;
      var gameWithPause_timeOfDay = game$prime$prime_timeOfDay;
      var gameWithPause_gameSpeed = game$prime$prime_gameSpeed;
      var gameWithPause_player = game$prime$prime_player;
      ...
      var gameWithPause_known = game$prime$prime_known;
      var gameWithPause_plants = game$prime$prime_plants;
      var gameWithPause = {
        startTime: gameWithPause_startTime,
        worldTime: gameWithPause_worldTime,
        realTime: gameWithPause_realTime,
        timeOfDay: gameWithPause_timeOfDay,
        ...
        known: gameWithPause_known,
        plants: gameWithPause_plants
      };
      if (paused) {
...
},{"./cityMethods.bs.js":34,"./constants.bs.js":36,"./contypes.bs.js":37,"./namegen.bs.js":46,"./playerMethods.bs.js":48,"./tod.bs.js":51,"./workerMethods.bs.js":54,"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25}],43:[function(require,module,exports){
var demo = require('./demo.bs');
demo.main(document.getElementById('demo'));

},{"./demo.bs":38}],44:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/caml_option.js":16}],45:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./canvas.bs.js":33,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25}],46:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/list.js":25}],47:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/caml_primitive.js":17}],48:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function newPlayer(param) {
  return {
          x: Constants.worldSide / 2.0,
          y: Constants.worldSide / 2.0,
          food: 1.0,
          gold: 0.0,
          knowledge: /* [] */0,
          health: 1.0
...
},{"./constants.bs.js":36}],49:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./canvas.bs.js":33,"./color.bs.js":35,"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/caml_string.js":18,"bs-platform/lib/js/curry.js":24}],50:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./sprite.bs.js":49}],51:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/curry.js":24}],54:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function runWorker(gamestate, incT, worker) {
  if (worker.death > 0.0) {
    ...
    var target = Gamestate.locationOfWorkerTarget(gamestate, worker.target);
    var home = Gamestate.locationOfWorkerTarget(gamestate, /* TargetEntity */Block.__(0, [worker.home]));
...
},{"./gamestate.bs.js":41,"./namegen.bs.js":46,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_obj.js":15}],55:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./canvas.bs.js":33,"./color.bs.js":35,"./contypes.bs.js":37,"./gamepalette.bs.js":40,"./tod.bs.js":51,"./weather.bs.js":52,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/printf.js":28}]},{},[43]);
