...
var get_context_2d = ( function(name) { var canvasElt = document.getElementById(name); if (!canvasElt) { return null; } return canvasElt.getContext('2d'); } );

var setFocus = ( function(name) { var elt = document.getElementById(name); elt.focus(); } );

var fillStyleOfString = ( function(s) { return s; } );

exports.get_context_2d = get_context_2d;
exports.setFocus = setFocus;
exports.fillStyleOfString = fillStyleOfString;
/* get_context_2d Not a pure module */
...
},{"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/caml_obj.js":15,"bs-platform/lib/js/caml_option.js":16,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/map.js":26,"bs-platform/lib/js/set.js":29}],36:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function runGame(state, ts) {
  ...
  var tod = Gamestate.timeOfDayFromWorldTime(newGame.worldTime);
  Gamedisplay.displayScreen(state.spec, newGame.weather, tod, state.world, newGame.mode);
...
function main(param) {
  var match = Curry._1(Canvas.get_context_2d, "demo");
  if (match == null) {
    ...
    var noise = Perlin.noiseArray(4096);
    ...
    var state_game = Gamestate.newGame(/* () */0);
...
},{"./animate.bs.js":32,"./canvas.bs.js":33,"./contypes.bs.js":35,"./gamedisplay.bs.js":37,"./gamestate.bs.js":38,"./perlin.bs.js":40,"./window.bs.js":41,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/string.js":30}],37:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
var clearSkyPalette = /* array */[/* array */[
    /* tuple */[
      7,
      5
    ],
...
function backgroundPaletteByTimeOfDay(weather, timeOfDay) {
  var slices = clearSkyPalette.length;
  return Caml_array.caml_array_get(clearSkyPalette, Math.floor(timeOfDay * slices));
}

function groundPaletteByTimeOfDay(weather, timeOfDay) {
  var slices = clearGroundPalette.length;
  return Caml_array.caml_array_get(clearGroundPalette, Math.floor(timeOfDay * slices));
}

function backgroundColor(weather, timeOfDay) {
  var palette = backgroundPaletteByTimeOfDay(weather, timeOfDay);
...
function drawFirstPersonBackdrop(disp, weather, timeOfDay) {
  var ctx = disp.context2d;
  var bgcolor = backgroundColor(weather, timeOfDay);
  var skyPalette = backgroundPaletteByTimeOfDay(weather, timeOfDay);
  var groundPalette = groundPaletteByTimeOfDay(weather, timeOfDay);
  ...
  drawSkyGradient(disp, skySteps, skyPalette);
  return drawGroundGradient(disp, groundSteps, groundPalette);
}
...
function drawMapScreen(spec, weather, tod, ground) {
  var ctx = spec.context2d;
  var palette = Caml_array.caml_array_get(mapPalette, 0);
  var bgColor = Caml_array.caml_array_get(palette, palette.length - 1 | 0);
  ctx.fillStyle = Curry._1(Canvas.fillStyleOfString, Color.stringOfColor(Color.colorOfCoord(bgColor)));
  for(var i = 0 ,i_finish = ground.groundY - 1 | 0; i <= i_finish; ++i){
    var yTop = Caml_int32.div(Caml_int32.imul(i, spec.height), ground.groundY);
    var yBot = Caml_int32.div(Caml_int32.imul(i + 1 | 0, spec.height), ground.groundY);
    for(var j = 0 ,j_finish = ground.groundX - 1 | 0; j <= j_finish; ++j){
      var xLeft = Caml_int32.div(Caml_int32.imul(j, spec.width), ground.groundX);
      var xRight = Caml_int32.div(Caml_int32.imul(j + 1 | 0, spec.width), ground.groundX);
      var level = Caml_array.caml_array_get(ground.groundData, Caml_int32.imul(i, ground.groundX) + j | 0);
...
function displayScreen(spec, weather, tod, ground, param) {
  switch (param) {
    case /* HomeScreen */0 :
        drawFirstPersonBackdrop(spec, weather, tod);
        return drawMenu(spec, /* :: */[
                    {
                      color: "white",
                      str: "Start"
                    },
    ...
    case /* MapScreen */1 :
        return drawMapScreen(spec, weather, tod, ground);
    case /* CampScreen */2 :
        drawFirstPersonBackdrop(spec, weather, tod);
        return drawMenu(spec, /* :: */[
                    {
    ...
    case /* FirstPerson */3 :
        return drawFirstPersonBackdrop(spec, weather, tod);
...
},{"./canvas.bs.js":33,"./color.bs.js":34,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25}],38:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function runGame(game$prime, keys, ts) {
  var match = game$prime.mode;
  if (match !== 0) {
    var realTime = ts - game$prime.startTime;
    return {
            startTime: game$prime.startTime,
            worldTime: realTime / (game$prime.gameSpeed * 1000.0),
            realTime: realTime,
            gameSpeed: game$prime.gameSpeed,
            player: game$prime.player,
            mode: game$prime.mode,
            weather: game$prime.weather
          };
  } else {
    var spacePressed = Curry._2(Contypes.StringSet.mem, " ", keys);
    if (spacePressed) {
      return startGame(game$prime);
    } else {
      return game$prime;
    }
  }
...
},{"./contypes.bs.js":35,"bs-platform/lib/js/curry.js":24}],39:[function(require,module,exports){
var demo = require('./demo.bs');
demo.main(document.getElementById('demo'));

},{"./demo.bs":36}],40:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/caml_primitive.js":17}],41:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/curry.js":24}]},{},[39]);
