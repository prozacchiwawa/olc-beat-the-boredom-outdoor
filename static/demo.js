...
},{"./city.bs.js":34,"./math.bs.js":48,"./namegen.bs.js":50,"./workerMethods.bs.js":59,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_primitive.js":17,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25,"bs-platform/lib/js/printf.js":28}],36:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./animate.bs.js":32,"./canvas.bs.js":33,"./constants.bs.js":37,"./contypes.bs.js":38,"./gamedisplay.bs.js":42,"./gamestateMethods.bs.js":45,"./perlin.bs.js":51,"./window.bs.js":58,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/string.js":30}],40:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
var FirstPerson = require("./firstPerson.bs.js");
var Caml_primitive = require("bs-platform/lib/js/caml_primitive.js");

var emptyMinigame_values = Caml_array.caml_make_vect(Caml_int32.imul(FirstPerson.boardSize, FirstPerson.boardSize), undefined);

var emptyMinigame = {
  values: emptyMinigame_values,
  actors: /* [] */0,
  objects: /* [] */0,
  playerX: 7.5,
  playerY: 15.5,
...
function indexOf(x, y) {
  return Caml_int32.imul(Caml_int32.mod_(y, FirstPerson.boardSize), FirstPerson.boardSize) + Caml_int32.mod_(x, FirstPerson.boardSize) | 0;
}

var badMinigameDef = /* array */[
  "rrrrrrrxrrrrrr",
  "rpppp    ppppr",
  "r p   t   pppr",
  "r pp      pp r",
...
function coordOf(i) {
  var y = Caml_int32.div(i, FirstPerson.boardSize);
  var x = Caml_int32.mod_(i, FirstPerson.boardSize);
  return /* tuple */[
          x,
          y
        ];
...
function findEntrance(minigame) {
  var candidates = Contypes.catOptions($$Array.to_list($$Array.mapi((function (i, v) {
                  if (isEntrance(v)) {
                    return i;
                  }
...
function viewDirection(playerDir) {
  return /* tuple */[
          Math.cos(playerDir),
          -1.0 * Math.sin(playerDir)
        ];
}

function rotateCoords(dir, param) {
  var py = param[1];
  var px = param[0];
  var x = px * Math.cos(dir) - py * Math.sin(dir);
  var y = py * Math.cos(dir) + px * Math.sin(dir);
  return /* tuple */[
          x,
          y
        ];
...
function chooseDecoSprite(param) {
  switch (param) {
    case /* Plant */0 :
        return SpriteDefs.plantSprite;
    case /* Tree */1 :
        return SpriteDefs.treeSprite;
    case /* Rock */2 :
        return SpriteDefs.rockSprite;
    case /* Entrance */3 :
...
function draw(state, minigame) {
  var objectsOnGrid = $$Array.mapi((function (i, v) {
          if (v !== undefined) {
            var match = coordOf(i);
            var ax = Caml_int32.imul(match[0], 10) + 5.0 - minigame.playerX * 10.0;
            var ay = Caml_int32.imul(match[1], 10) + 5.0 - minigame.playerY * 10.0;
            return /* tuple */[
...
exports.emptyMinigame = emptyMinigame;
exports.indexOf = indexOf;
exports.badMinigameDef = badMinigameDef;
...
exports.handleRot = handleRot;
/* Math Not a pure module */

},{"./contypes.bs.js":38,"./firstPerson.bs.js":40,"./math.bs.js":48,"./sprite.bs.js":54,"./spriteDefs.bs.js":55,"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/caml_primitive.js":17,"bs-platform/lib/js/caml_string.js":18,"bs-platform/lib/js/list.js":25}],42:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
var Caml_primitive = require("bs-platform/lib/js/caml_primitive.js");
var FirstPersonMethods = require("./firstPersonMethods.bs.js");
...
function drawCityStatus(state, city) {
  ...
  Sprite.drawSpriteCenter(state.spec, city.ruin !== 0.0 ? SpriteDefs.ruinSprite : SpriteDefs.citySprite, 15, (ystart + yend | 0) / 2 | 0, (SpriteDefs.citySprite.width << 1), (SpriteDefs.citySprite.height << 1));
  ...
  var maxView = Caml_primitive.caml_float_max(200.0, city.population > city.food ? city.population : city.food);
  ...
  state.spec.context2d.fillStyle = Curry._1(Canvas.fillStyleOfString, "white");
  state.spec.context2d.fillText(tagline, 30, (ystart + 5 | 0) + ascent | 0);
  state.spec.context2d.fillStyle = Curry._1(Canvas.fillStyleOfString, Color.stringOfColor(Color.colorOfCoord(/* tuple */[
                11,
                4
              ])));
  var foodBarY = (ystart + 5 | 0) + oneUnit | 0;
  state.spec.context2d.fillRect(30, foodBarY, foodWidth | 0, ascent);
  state.spec.context2d.fillStyle = Curry._1(Canvas.fillStyleOfString, Color.stringOfColor(Color.colorOfCoord(/* tuple */[
                3,
                4
              ])));
  var popBarY = (ystart + 5 | 0) + (oneUnit << 1) | 0;
  state.spec.context2d.fillRect(30, popBarY, popWidth | 0, ascent);
  return /* () */0;
}
...
function drawMiscHud(state) {
  ...
  if (typeof match === "number") {
    ...
    switch (match.tag | 0) {
      case /* GameOverScreen */0 :
          return /* () */0;
      case /* MapScreen */1 :
          var match$1 = match[0];
          if (typeof match$1 === "number") {
            return drawUpperRightStatus(state, Curry._1(Printf.sprintf(/* Format */[
                                /* String_literal */Block.__(11, [
                                    "Running: ",
                                    /* String */Block.__(2, [
                                        /* No_padding */0,
      ...
      case /* FirstPerson */2 :
          var mg = match[0];
          return drawUpperRightStatus(state, Curry._3(Printf.sprintf(/* Format */[
                              /* String_literal */Block.__(11, [
                                  "First Person ",
                                  /* Float */Block.__(8, [
                                      /* Float_f */0,
                              ...
                              "First Person %f:%f v %f"
                            ]), mg.playerX, mg.playerY, mg.playerDir));
...
function displayScreen(state) {
  ...
  if (typeof match === "number") {
    ...
    switch (match.tag | 0) {
      ...
      case /* FirstPerson */2 :
          drawFirstPersonBackdrop(state);
          FirstPersonMethods.draw(state, match[0]);
          drawMiscHud(state);
          return drawCityHud(state);
...
exports.cityStatusLeft = cityStatusLeft;
...
},{"./canvas.bs.js":33,"./color.bs.js":36,"./constants.bs.js":37,"./contypes.bs.js":38,"./firstPersonMethods.bs.js":41,"./gamepalette.bs.js":43,"./math.bs.js":48,"./menu.bs.js":49,"./sprite.bs.js":54,"./spriteDefs.bs.js":55,"./weather.bs.js":57,"./worldmap.bs.js":60,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/caml_obj.js":15,"bs-platform/lib/js/caml_primitive.js":17,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25,"bs-platform/lib/js/printf.js":28}],43:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function mapPaletteByWeather(param) {
  switch (param) {
    case /* Clear */0 :
    case /* Pokkari */1 :
        return clearMapPalette;
    case /* Fog */2 :
    case /* Overcast */3 :
        return overcastMapPalette;
    case /* Rain */4 :
    case /* Storm */5 :
        return darkMapPalette;
    case /* Snow */6 :
        return snowMapPalette;
...
exports.clearMapPalette = clearMapPalette;
exports.overcastMapPalette = overcastMapPalette;
exports.darkMapPalette = darkMapPalette;
exports.snowMapPalette = snowMapPalette;
exports.skyPaletteByWeather = skyPaletteByWeather;
exports.groundPaletteByWeather = groundPaletteByWeather;
exports.mapPaletteByWeather = mapPaletteByWeather;
...
},{"bs-platform/lib/js/caml_array.js":5}],44:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./contypes.bs.js":38,"bs-platform/lib/js/curry.js":24}],45:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function runWeather(game) {
  var px = game.player.x | 0;
  var py = game.player.y | 0;
  var altitude = Caml_array.caml_array_get(game.world.groundData, Caml_int32.imul(py, game.world.groundX) + px | 0);
  var altitudeBlock = altitude * 7.0 | 0;
  var prob = 1.0 - altitude;
  var stepDownProb = prob * prob;
  if (stepDownProb < Math.random()) {
    return {
            startTime: game.startTime,
            worldTime: game.worldTime,
            realTime: game.realTime,
            ...
            player: game.player,
            mode: game.mode,
            weather: Weather.stepDownWeather(altitudeBlock, game.weather),
            world: game.world,
            keys: game.keys,
            cities: game.cities,
            workers: game.workers,
    ...
    return {
            ...
            player: game.player,
            mode: game.mode,
            weather: Weather.stepUpWeather(altitudeBlock, game.weather),
            world: game.world,
            keys: game.keys,
            cities: game.cities,
            workers: game.workers,
...
function runDayCycle(game, ts) {
  ...
  var newWeatherBlock = (worldTime / Weather.weatherTime | 0) !== (lastWorldTime / Weather.weatherTime | 0);
  var game$1 = newWeatherBlock && Weather.weatherChangePct < Math.random() ? runWeather(game) : game;
  return {
...
function oneFrame(game, ts) {
  ...
  var worldTime = game$1.worldTime;
...
function runGame(game$prime, keys, ts) {
  ...
  if (typeof match === "number") {
    ...
    switch (match.tag | 0) {
      ...
      case /* FirstPerson */2 :
          var mg = match[0];
          var lastWorldTime = game_worldTime;
          var game$1 = runDayCycle(game, ts - lastTs);
          var worldTime = game$1.worldTime;
          var timeInc = worldTime - lastWorldTime;
          var downPressed$1 = Curry._2(Contypes.StringSet.mem, "ARROWDOWN", keys);
...
},{"./cityMethods.bs.js":35,"./constants.bs.js":37,"./contypes.bs.js":38,"./firstPersonMethods.bs.js":41,"./gamestate.bs.js":44,"./life.bs.js":46,"./math.bs.js":48,"./plants.bs.js":52,"./playerMethods.bs.js":53,"./tod.bs.js":56,"./weather.bs.js":57,"./workerMethods.bs.js":59,"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/caml_primitive.js":17,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25}],46:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./constants.bs.js":37,"./contypes.bs.js":38,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25}],47:[function(require,module,exports){
var demo = require('./demo.bs');
demo.main(document.getElementById('demo'));

},{"./demo.bs":39}],48:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./contypes.bs.js":38,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/caml_obj.js":15,"bs-platform/lib/js/caml_option.js":16,"bs-platform/lib/js/list.js":25}],49:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./canvas.bs.js":33,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25}],50:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/list.js":25}],51:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/caml_primitive.js":17}],52:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./constants.bs.js":37,"./contypes.bs.js":38,"./life.bs.js":46,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25}],53:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./constants.bs.js":37,"./math.bs.js":48}],54:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./canvas.bs.js":33,"./color.bs.js":36,"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/caml_string.js":18,"bs-platform/lib/js/curry.js":24}],55:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
var rockSprite = Sprite.compileSprite(rockDef);

var treeSprite = Sprite.compileSprite(treeDef);

var entranceSprite = Sprite.compileSprite(entranceDef);
...
function stepUpWeather(biome, current) {
  if (biome > 4 && current === /* Storm */5) {
    return /* Snow */6;
  } else {
    return $$Math.nextOf(current, weatherCycle);
  }
}

function stepDownWeather(biome, current) {
  if (current === /* Snow */6) {
    return /* Storm */5;
  } else {
    return $$Math.prevOf(current, weatherCycle);
  }
}

var weatherTime = 0.25;

var weatherChangePct = 0.3;

exports.weatherTime = weatherTime;
exports.weatherChangePct = weatherChangePct;
exports.weatherToString = weatherToString;
exports.weatherCycle = weatherCycle;
exports.stepUpWeather = stepUpWeather;
exports.stepDownWeather = stepDownWeather;
/* Math Not a pure module */

},{"./math.bs.js":48}],58:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/curry.js":24}],59:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
},{"./contypes.bs.js":38,"./gamestate.bs.js":44,"./math.bs.js":48,"./namegen.bs.js":50,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_obj.js":15,"bs-platform/lib/js/curry.js":24}],60:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function cacheMapScreen(state) {
  ...
  try {
    ...
    return Curry._4(Canvas.ImageFromCanvas.withNewCanvas, "hidden", state.spec.width, state.spec.height, (function (canvas) {
                  var ctx = Curry._1(Canvas.getContext2D, canvas);
                  var palette = Gamepalette.getPaletteByTimeOfDay(Gamepalette.mapPaletteByWeather(state.game.weather), state.game.timeOfDay);
...
},{"./canvas.bs.js":33,"./color.bs.js":36,"./contypes.bs.js":38,"./gamepalette.bs.js":43,"./tod.bs.js":56,"./weather.bs.js":57,"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/printf.js":28}]},{},[47]);
