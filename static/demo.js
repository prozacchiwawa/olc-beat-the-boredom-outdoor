...
},{"bs-platform/lib/js/block.js":2,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/printf.js":28}],35:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function runGame(state, ts) {
  ...
  Gamedisplay.displayScreen(state.spec, newGame.weather, tod, newGame.mode);
...
function drawMenu(spec, textLines) {
  ...
  console.log($$Array.of_list(withMetrics));
...
function displayScreen(spec, weather, tod, param) {
  if (param !== 0) {
    if (param >= 3) {
...
},{"./canvas.bs.js":33,"./color.bs.js":34,"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11,"bs-platform/lib/js/curry.js":24,"bs-platform/lib/js/list.js":25}],38:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
...
function noiseField(noise, x, y) {
  ...
  var sample = function (scale, xx, yy) {
    var xSample = Caml_int32.mod_(Caml_int32.imul(xx, scale), x);
    var ySample = Caml_int32.mod_(Caml_int32.imul(yy, scale), y);
    return isample(xSample, ySample) / scale;
  };
  return {
          groundX: x,
          groundY: y,
          groundData: $$Array.init(Caml_int32.imul(x, y), (function (i) {
...
},{"bs-platform/lib/js/array.js":1,"bs-platform/lib/js/caml_array.js":5,"bs-platform/lib/js/caml_int32.js":11}],41:[function(require,module,exports){
// Generated by BUCKLESCRIPT, PLEASE EDIT WITH CARE
'use strict';
